...
PAGINAS=(/ /funciones /para /para/taller-general /para/centro-de-servicio /para/vehiculos-electricos /recursos /recursos/recepcion-sin-reclamos /recursos/cobrar-la-inspeccion /plantillas /plantillas/orden-de-trabajo /plantillas/inspeccion-12-puntos /precios /aria /contacto /privacidad /terminos)
